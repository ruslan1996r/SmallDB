...
class PDFDocumentWithTables extends PDFDocument {
  constructor(options: PDFKit.PDFDocumentOptions | undefined) {
    super(options);
  }

  table(table: { headers: any[]; rows: any[]; }, arg0: number, arg1: number, arg2: {}) {
    ...
    const columnSpacing = options.columnSpacing || 7;
